...
<body class="bg-gray-50">
        ...
        <div class="absolute bottom-0 left-0 right-0 p-6">
            <div class="container mx-auto flex items-end space-x-4">
                ...
                <div class="ml-auto flex items-center space-x-4">
                    ...
                    <!-- Carrinho -->
                    <button id="cart-button" class="bg-white text-gray-800 px-4 py-2 rounded-lg shadow-lg hover:bg-gray-100 transition-colors flex items-center space-x-2">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Carregar carrinho se cliente estiver logado
            if (currentClient) {
                loadCart();
            }
        });
